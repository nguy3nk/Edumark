...
namespace EduWeb.Areas.Admin.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Class @class = _classRepository.GetAll().AsQueryable().Include(c => c.Course).Include(c => c.Lecturer).Include(p => p.Students).Include(p => p.Students.Select(st => st.Scores)).FirstOrDefault(x => x.ClassId == id);
