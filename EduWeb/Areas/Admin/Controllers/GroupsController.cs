...
namespace EduWeb.Areas.Admin.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GroupId,GroupName,IsAdmin,Status")] Group group)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GroupId,GroupName,IsAdmin,Status")] Group group)
        {
            if (ModelState.IsValid)
            {
